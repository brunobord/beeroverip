...
stable release at the time the project was started. Migration onto more recent Django versions is planned, but not yet.
...
Inside your project, type the command::
    ...
    $ git clone git@github.com:brunobord/beeroverip.git beers
