...
You can still use this website by sending non-beer beverage. Just point to
http://beeroverip/notabeer/ to send a coffee, for example. The list of all our
non-beer drinks are available at http://beeroverip.org/notabeer/all/

And if you miss a drink you would like to send, you may help the same way
(see the `about` page)
...
``https://github.com/brunobord/beeroverip/``
